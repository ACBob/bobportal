...
void CPortal_Player::GiveDefaultItems( void )
{
    ...
    inputdata_t inputdata = inputdata_t(); // I don't know how to pass by reference, OK?!!! -ACBob
	InputDisableFlashlight( inputdata );
}
...
void CPortal_Player::SetupBones( matrix3x4_t *pBoneToWorld, int boneMask )
{
	...
	Studio_BuildMatrices( 
		...
		0,
		boneMask,
        pParent ); // TODO: these are probably the wrong things to pass to it. Bite me. -ACBOB
}
