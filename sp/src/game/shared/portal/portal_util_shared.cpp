...
public:
    ...
    // ACBOB - Trying to un-abstract this class
    virtual const Vector& CTransformedCollideable::OBBMinsPreScaled() const;
    virtual const Vector& CTransformedCollideable::OBBMaxsPreScaled() const;
};

// ACBOB - Trying to un-abstract this class
const Vector& CTransformedCollideable::OBBMinsPreScaled() const {
    return m_pWrappedCollideable->OBBMinsPreScaled();
}
const Vector& CTransformedCollideable::OBBMaxsPreScaled() const {
    return m_pWrappedCollideable->OBBMinsPreScaled();
}
